...
cv2.imwrite('objetoRecort.jpg',recorte)       
...
umbral = 0.60                                                        # Asignamos un umbral para filtrar objetos parecidos
...
cv2.imwrite('DeteccionRecog.jpg',img) 
# cv2.imshow('DeteccionRecog.jpg',img)
cv2.imshow('Deteccion',img)
